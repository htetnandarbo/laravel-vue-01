...
import { create, destroy, edit } from '@/actions/App/Http/Controllers/QuestionController';
                        ...
                        <Table>
                            <TableHeader class="border-none bg-gray-100">
                                <TableRow class="border-none">
                                    ...
                                    <TableHead class="h-fit py-3">Question</TableHead>
                                    <TableHead class="h-fit py-3">Type</TableHead>
                                    <TableHead class="h-fit py-3">Is Required</TableHead>
                                    <TableHead class="h-fit py-3">Order</TableHead>
                            ...
                            <TableBody>
                                <TableRow v-for="(question, index) in questions" :key="question.id">
                                    ...
                                    <TableCell class="h-fit py-2">{{ question.question_text }}</TableCell>
                                    <TableCell class="h-fit py-2">{{ question.type }}</TableCell>
                                    <TableCell class="h-fit py-2">{{ question.is_required }}</TableCell>
                                    <TableCell class="h-fit py-2">{{ question.order }}</TableCell>
